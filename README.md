...
This project focuses on the design and construction of a modern data warehouse using a layered architecture. The scope of the work covers data ingestion, transformation, and modeling across Bronze, Silver, and Gold layers.
...
Gold Layer
Holds curated, business-ready data structured using dimensional modeling (star schema). The data in this layer is prepared for downstream analytics, even though reporting is outside the scope of this project.
...
This repository represents a data engineering–focused project emphasizing proper warehouse design and structured data preparation. It serves as a foundation for future analytics and BI development
